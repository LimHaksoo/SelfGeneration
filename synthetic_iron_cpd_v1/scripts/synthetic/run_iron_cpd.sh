...
# CPD only.  Existing AUP/AUR/Completeness JSONs are not recomputed.
# If iron_attributions.npy is absent, the evaluator can regenerate only the
# TIMING-style IRON saliency cache from the existing flow/classifier checkpoints.
